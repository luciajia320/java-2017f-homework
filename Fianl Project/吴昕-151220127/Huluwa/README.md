...
只有**葫芦娃**和**小喽啰**是具备战斗能力的，**爷爷**很鸡肋，不会跑不会动；**蝎子精**和**蛇精**站着指挥不腰疼，**葫芦娃**死了**爷爷**就保不住了，**蝎子精**和**蛇精**没了**小喽啰**的保护打不过葫芦娃了，要被压在七色山下了(我不接受反驳我又没看过葫芦娃！我不管！游戏规则我来定！）
...
|快捷键|功能|
|-|-|
|SPACE|启动游戏；暂停状态下继续游戏；读取存档状态下直接跳到结果|
|ESCAPE|退出游戏|
|S|开始界面下读取存档|
|P|暂停游戏|
|C|暂停状态下继续游戏|
...
伏羲为了这群熊孩子能打赢也是操碎了心，为了能往**Ground**上放，先把他们放进一个阵型里面，再在**Ground**上放置所有角色。伏羲为他们量身定制了两个阵型，给葫芦娃选了鹤翼，给小喽啰选了衝軛。（说实话，老师提供的那些阵型高端到我连读都不会读，选这两个纯粹是因为眼缘。）
