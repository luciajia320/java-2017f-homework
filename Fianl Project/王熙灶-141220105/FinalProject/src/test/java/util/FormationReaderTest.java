...
public class FormationReaderTest {
    @Test
    public void test_readDongE() throws Exception {
        ArrayList<Point> ap = FormationReader.read("DongE.xml");
    ...
    public void test_readFangYuan() throws Exception {
        ArrayList<Point> ap = FormationReader.read("FangYuan.xml");
        assertEquals(0, ap.get(0).x);
        assertEquals(0, ap.get(0).y);
    ...
    public void test_readFengShi() throws Exception {
        ArrayList<Point> ap = FormationReader.read("FengShi.xml");
        assertEquals(0, ap.get(0).x);
        assertEquals(0, ap.get(0).y);
    ...
    public void test_readHeYi() throws Exception {
        ArrayList<Point> ap = FormationReader.read("HeYi.xml");
        assertEquals(0, ap.get(0).x);
        assertEquals(0, ap.get(0).y);
    ...
    public void test_readLongSnake() throws Exception {
        ArrayList<Point> ap = FormationReader.read("LongSnake.xml");
        assertEquals(0, ap.get(0).x);
        assertEquals(0, ap.get(0).y);
