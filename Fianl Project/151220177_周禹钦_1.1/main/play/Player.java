...
public class Player extends Thing2D implements Runnable {
    ...
    private URL getHeadPic(){
        ...
        if(role.getStatus()== STATUS.爷爷)
            loc = this.getClass().getResource("/main/picture/grandfa.png");
        else if(role.getClass()==HuLuWa.class)
            switch (role.getStatus()) {
                case 大娃:loc = this.getClass().getResource("/main/picture/red.png");break;
                case 二娃:loc = this.getClass().getResource("/main/picture/orange.png");break;
                case 三娃:loc = this.getClass().getResource("/main/picture/yellow.png");break;
                case 四娃:loc = this.getClass().getResource("/main/picture/green.png");break;
                case 五娃:loc = this.getClass().getResource("/main/picture/dark.png");break;
                case 六娃:loc = this.getClass().getResource("/main/picture/blue.png");break;
                case 七娃:loc = this.getClass().getResource("/main/picture/purple.png");break;
                default:loc = this.getClass().getResource("/main/picture/red.png");break;
            }
        else if(role.getClass()==MonsterScorpion.class)
            loc = this.getClass().getResource("/main/picture/scorpion.png");
        else if(role.getClass()==MonsterSnake.class)
            loc = this.getClass().getResource("/main/picture/snake.png");
        else
            loc = this.getClass().getResource("/main/picture/frog.png");
        return loc;
    }
