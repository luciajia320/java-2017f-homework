 ...
 */
public class HU2 extends Thing2D implements Runnable{
    private Field field;
    private char record[][]=new char[13][13];
    public HU2(int x, int y,Field field,char record[][]) {
        super(x, y);
        this.field = field;
        this.record=record;
        URL loc = this.getClass().getClassLoader().getResource("2.jpg");
