 ...
 */
public class Toad extends Thing2D implements Runnable{
    private Field field;
    private char record[][]=new char[13][13];
    boolean isdead;
    public Toad(int x, int y,Field field,char record[][]) {
        super(x, y);
        this.field = field;
        this.record=record;
        isdead=false;
        URL loc = this.getClass().getClassLoader().getResource("toad.jpg");
