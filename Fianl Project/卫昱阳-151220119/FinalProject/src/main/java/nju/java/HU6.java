 ...
 */
public class HU6 extends Thing2D implements Runnable{
    private Field field;
    private char record[][]=new char[13][13];
    public HU6(int x, int y,Field field,char record[][]) {
        super(x, y);
        this.field = field;
        this.record=record;
        URL loc = this.getClass().getClassLoader().getResource("6.jpg");
