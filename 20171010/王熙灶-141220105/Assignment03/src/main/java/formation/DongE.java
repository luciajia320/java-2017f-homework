 ...
 *     X   X   X
 */
public final class DongE extends BasicFormation {
    /**
     * @param space, 摆放阵法的空间
     * @param x, 阵头的x方向位置
     * @param y, 阵头的y方向位置
     ...
     */
    public DongE(Space space, int x, int y) throws FormationException {
        super(space, x, y);
        ArrayList<Point> points = XmlReader.readFromFile("DongE.xml");
        try {
            ...
            throw new FormationException("DongE");
        }
    }
}